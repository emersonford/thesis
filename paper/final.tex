...
Unfortunately, with SR-IOV implementations being a black box, it's difficult to reason about why the use of SR-IOV incurs latency and bandwidth penalties.
